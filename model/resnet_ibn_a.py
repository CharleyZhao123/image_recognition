"""
  Adapted from https://github.com/michuanhaohao/reid-strong-baseline/blob/master/modeling/backbones/resnet_ibn_a.py
"""
...
__all__ = [
    'ResNet_IBN', 'resnet50_ibn_a', 'resnet101_ibn_a', 'resnet152_ibn_a'
]
