...
class IC(object):
    def __init__(self, cfg, dataset_type='train'):
        ...
        if dataset_type is 'train':
            self.train_path = os.path.join(self.dataset_path, 'train_simulation_addtrue.csv')
            ...
            self.test_path = os.path.join(self.dataset_path, 'test_true.csv')
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, item):
        if self.dataset_type is 'train':
            ...
            return image, image_id, image_name  # image_name for generate result csv
